...
public class ControllerExceptionHandler {
    ...
    public ErrorMessage resourceCouldNotBeSavedException(ResourceNotSavedException ex, WebRequest request) {
    ...
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public ErrorMessage resourceCouldNotBeDeletedException(ResourceNotDeletedException ex, WebRequest request) {
